...
class BakimKaydi(ModelBase):
    ...
    aciklama: Mapped[str] = mapped_column(Text())
    bakim_turu: Mapped[str | None] = mapped_column(String(80))
    oncelik: Mapped[str | None] = mapped_column(String(40))
    maliyet_tl: Mapped[Decimal] = money_column(default=Decimal("0.00"))
    parca_maliyeti_tl: Mapped[Decimal | None] = mapped_column(Numeric(12, 2))
    iscilik_maliyeti_tl: Mapped[Decimal | None] = mapped_column(Numeric(12, 2))
    tedarikci: Mapped[str | None] = mapped_column(String(160))
    kilometre: Mapped[int | None] = mapped_column(Integer)
    planlanan_tarih: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
...
class TesisTeslim(ModelBase):
    ...
    atik_tipi: Mapped[AtikTipi | None] = mapped_column(Enum(AtikTipi, name="teslim_atik_tipi_enum"))
    aciklama: Mapped[str | None] = mapped_column(Text())
...
class Satis(ModelBase):
    ...
    alici_firma: Mapped[str | None] = mapped_column(String(255))
    belge_no: Mapped[str | None] = mapped_column(String(120))
    durum: Mapped[OnayDurumu] = mapped_column(
